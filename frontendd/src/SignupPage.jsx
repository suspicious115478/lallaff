...
function SignupPage({ onSignupSuccess, goToLogin }) {
  ...
  return (
    <div style={ui.container}>
      <div style={ui.card}>
        <h2 style={ui.title}>Create Account</h2>
        ...
        <form onSubmit={submitSignup}>
          ...
          <div style={{ marginBottom: 18 }}>
            <label style={ui.label}>Admin ID</label>
            <input
              style={ui.input}
              required
              value={adminId}
          ...
          <button style={ui.buttonPrimary}>Signup</button>
        </form>

        <button style={ui.buttonSecondary} onClick={goToLogin}>
